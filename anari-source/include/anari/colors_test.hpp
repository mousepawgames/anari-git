...
public:
	Test_CMYKtoRGBA() : rgba_goal(10, 20, 30, 255), cmyk_start(67, 33, 0, 88) {}

	testdoc_t get_title() override { return "Convert CMYK to RGBA"; }
...
public:
	Test_RGBAtoCMYK() : cmyk_goal(67, 33, 0, 88), rgba_start(10, 20, 30, 255) {}

	testdoc_t get_title() override { return "Convert RGBA to CMYK"; }
...
public:
	Test_HSLtoRGBA() : rgba_goal(10, 20, 30, 255), hsl_start(210.0, 50.0, 7.8)
	{
	}

	testdoc_t get_title() override { return "Convert HSL to RGBA"; }
...
public:
	Test_RGBAtoHSL() : hsl_goal(210.0, 50.0, 7.8), rgba_start(10, 20, 30, 255)
	{
	}

	testdoc_t get_title() override { return "Convert RGBA to HSL"; }
	...
	bool run() override
	{
		...
		PL_ASSERT_EQUAL(hsl_test.luminance, hsl_goal.luminance);
		return true;
	}
...
public:
	...
	: rgba_goal(10, 20, 30, 255), rgbadouble_start(0.039, 0.078, 0.118, 1.0)
	{
	}

	testdoc_t get_title() override { return "Convert RGBADouble to RGBA"; }
...
public:
	...
	: rgbadouble_goal(0.039, 0.078, 0.118, 1.0), rgba_start(10, 20, 30, 255)
	{
	}

	testdoc_t get_title() override { return "Convert RGBA to RGBADouble"; }
...
public:
	Test_HEXtoRGBA() : rgba_goal(10, 20, 30, 255), rgba_start(0xA141EFF) {}

	testdoc_t get_title() override { return "Convert HEX to RGBA"; }
...
public:
	Test_RGBAtoHEX() : hex_goal(0xA141EFF), rgba_start(10, 20, 30, 255) {}

	testdoc_t get_title() override { return "Convert RGBA to HEX"; }
...
public:
	Test_RGBAConstructor() : red(10), green(20), blue(30), alpha(255) {}

	testdoc_t get_title() override { return "Check RGBA Constructor"; }
...
public:
	Test_CMYKConstructor() : cyan(10.0), magenta(20.0), yellow(30.0), key(15.0)
	{
	}

	testdoc_t get_title() override { return "Check CMYK Constructor"; }
...
public:
	Test_HSLConstructor() : hue(10.0), saturation(20.0), luminance(30.0) {}

	testdoc_t get_title() override { return "Check HSL Constructor"; }
	...
	bool run() override
	{
		...
		PL_ASSERT_EQUAL(hsl_test.luminance, luminance);
		return true;
	}
...
public:
	Test_RGBADoubleConstructor() : red(0.5), green(0.4), blue(0.3), alpha(1.0)
	{
	}

	testdoc_t get_title() override { return "Check RGBADouble Constructor"; }
...
public:
	...
	testdoc_t get_title() override { return "Colors Tests"; }
